...
wall2_h (world){ shape:ssBox, Q:"t(1 -1 0.3)", size:[.1 2 0.6 .02], color:[1 0 0],contact: 1 }
...
obj1_cam_rel(obj1): { X: [-1.2, -0.3, 3.1,   0.00040292,  -0.99999992,   0.00000000,   0.00000000 ], shape: camera, size: [0.1], width: 30, height: 30, focalLength: 1, zRange: [0.2, 5]  },
...
obj2_cam_rel(obj2): { X: [-0.75, -1.2, 3.1,   0.00040292,  -0.99999992,   0.00000000,   0.00000000 ], shape: camera, size: [0.1], width: 30, height: 30, focalLength: 1, zRange: [0.2, 5]  },
...
obj3_cam_rel(obj3): { X: [-0.5, -1.4, 3.1,   0.00040292,  -0.99999992,   0.00000000,   0.00000000 ], shape: camera, size: [0.1], width: 30, height: 30, focalLength: 1, zRange: [0.2, 5]  },
...
obj4_cam_rel(obj4): { X: [-1.4, -0.75, 3.1,   0.00040292,  -0.99999992,   0.00000000,   0.00000000 ], shape: camera, size: [0.1], width: 30, height: 30, focalLength: 1, zRange: [0.2, 5]  },
