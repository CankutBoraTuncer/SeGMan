...
goal (floor){ shape:ssBox, Q:"t(-0.9 -1.6 .0)", size:[0.2 0.2 .1 .005], color:[1. .3 .3 0.9], contact:0, logical:{table} }
goal_visible (floor) 	{ shape:ssBox, Q:"t(-0.9 -1.6 0.1)", size:[0.2 0.2 0.1 0.005], color:[1. .3 .3] }
...
obj(objJoint) { 
    type:ssBox, Q: [-1.2 1.3 0], size:[.3 .3 .2 .02] color:[0. 0. 1.],  logical={ object },
